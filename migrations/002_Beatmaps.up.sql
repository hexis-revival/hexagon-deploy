CREATE TABLE beatmapsets (
    ...
    last_updated timestamp without timezone NOT NULL DEFAULT now(),
    approved_at timestamp without timezone NOT NULL DEFAULT now(),
...
CREATE TABLE beatmaps (
    id serial NOT NULL PRIMARY KEY REFERENCES beatmapsets (id),
...
CREATE INDEX idx_beatmaps_beatmap_md5 ON beatmaps(beatmap_md5);